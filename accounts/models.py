...
class UserModulePermission(models.Model):
    class Module(models.TextChoices):
        ...
        REQUISICOES_ANALISE = "requisicoes_analise", "Requisições - análise"
        REQUISICOES_ATENDIMENTO = "requisicoes_atendimento", "Requisições - atendimento"
        REQUISICOES_TODAS = "requisicoes_todas", "Requisições - todas"
