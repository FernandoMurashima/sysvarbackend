...
FORBIDDEN_OPERATIONAL_MODELS=[('accounts','SessaoUsuario'),('accounts','SessionToken'),('compras','Requisicao'),('compras','RequisicaoItem'),('compras','RequisicaoHistorico'),('compras','OrdemServico'),('compras','Cotacao'),('compras','PedidoCompra'),('distribuicao','Distribuicao'),('distribuicao','PedidoVendaDistribuicao'),('distribuicao','MercadoriaTransito'),('financeiro','CashbackMovimento'),('financeiro','ValeTroca'),('financeiro','ValeTrocaMovimento'),('financeiro','MovimentacaoFinanceira'),('financeiro','Pagar'),('financeiro','PagarItem'),('financeiro','Receber'),('financeiro','ReceberItem'),('fiscal','XmlFornecedorRecebido'),('fiscal','RecebimentoMercadoriaEstoque'),('fiscal','RecebimentoMercadoriaPedido'),('fiscal','RecebimentoMercadoriaConferenciaItem'),('fiscal','RecebimentoMercadoriaTermo'),('fiscal','RecebimentoMercadoriaEfetivacaoEstoque'),('fiscal','NotaFiscalEntrada'),('fiscal','NotaFiscalEntradaItem'),('fiscal','NotaFiscalEntradaItemXml'),('fiscal','NotaFiscalEntradaEvento'),('fiscal','NotaFiscalEntradaDivergenciaXml'),('fiscal','NotaFiscalSaida'),('fiscal','VendaPdv'),('fiscal','VendaDevolucao'),('fiscal','NFCe'),('produto','EstoqueMovimentacao'),('produto','ProdutoUsoConsumoMovimentacao'),('produto','InventarioEstoque'),('produto','OrdemProducao')]
@dataclass
class DevBaseReport:
