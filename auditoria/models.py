...
class AuditAction:
    ...
    PASSWORD_CHANGE_REQUIRED_ACCESS_DENIED = "PASSWORD_CHANGE_REQUIRED_ACCESS_DENIED"
    ...
    CLIENT_DELETE_DENIED = "CLIENT_DELETE_DENIED"
    CLIENT_DELETED = "CLIENT_DELETED"
    CLIENT_STANDARD_CREATED = "CLIENT_STANDARD_CREATED"
    CLIENT_STANDARD_CONFLICT = "CLIENT_STANDARD_CONFLICT"
    CLIENT_OPERATION_DENIED = "CLIENT_OPERATION_DENIED"
    ...
    SUPPLIER_DELETE_DENIED = "SUPPLIER_DELETE_DENIED"
    SUPPLIER_DELETED = "SUPPLIER_DELETED"
    SUPPLIER_CONTACT_CREATED = "SUPPLIER_CONTACT_CREATED"
    SUPPLIER_CONTACT_UPDATED = "SUPPLIER_CONTACT_UPDATED"
    SUPPLIER_CONTACT_DEACTIVATED = "SUPPLIER_CONTACT_DEACTIVATED"
    SUPPLIER_CONTACT_REACTIVATED = "SUPPLIER_CONTACT_REACTIVATED"
    SUPPLIER_ADDRESS_CREATED = "SUPPLIER_ADDRESS_CREATED"
    SUPPLIER_ADDRESS_UPDATED = "SUPPLIER_ADDRESS_UPDATED"
    SUPPLIER_ADDRESS_DEACTIVATED = "SUPPLIER_ADDRESS_DEACTIVATED"
    SUPPLIER_ADDRESS_REACTIVATED = "SUPPLIER_ADDRESS_REACTIVATED"
    EMPLOYEE_CREATED = "EMPLOYEE_CREATED"
    EMPLOYEE_UPDATED = "EMPLOYEE_UPDATED"
    EMPLOYEE_ROLE_CHANGED = "EMPLOYEE_ROLE_CHANGED"
    EMPLOYEE_STORE_CHANGED = "EMPLOYEE_STORE_CHANGED"
    EMPLOYEE_SCOPE_CHANGED = "EMPLOYEE_SCOPE_CHANGED"
    EMPLOYEE_LEAVE = "EMPLOYEE_LEAVE"
    EMPLOYEE_RETURNED = "EMPLOYEE_RETURNED"
    ...
    EMPLOYEE_DELETE_DENIED = "EMPLOYEE_DELETE_DENIED"
    ...
    VALID = {
        ...
        CLIENT_BLOCKED, CLIENT_UNBLOCKED, CLIENT_DELETE_DENIED, CLIENT_DELETED,
        CLIENT_STANDARD_CREATED, CLIENT_STANDARD_CONFLICT, CLIENT_OPERATION_DENIED,
        SUPPLIER_CREATED, SUPPLIER_UPDATED, SUPPLIER_ACTIVATED, SUPPLIER_DEACTIVATED,
        SUPPLIER_BLOCKED, SUPPLIER_UNBLOCKED, SUPPLIER_DELETE_DENIED, SUPPLIER_DELETED,
        SUPPLIER_CONTACT_CREATED, SUPPLIER_CONTACT_UPDATED, SUPPLIER_CONTACT_DEACTIVATED,
        SUPPLIER_CONTACT_REACTIVATED, SUPPLIER_ADDRESS_CREATED, SUPPLIER_ADDRESS_UPDATED,
        SUPPLIER_ADDRESS_DEACTIVATED, SUPPLIER_ADDRESS_REACTIVATED,
        EMPLOYEE_CREATED, EMPLOYEE_UPDATED, EMPLOYEE_ROLE_CHANGED, EMPLOYEE_STORE_CHANGED,
        EMPLOYEE_SCOPE_CHANGED, EMPLOYEE_LEAVE, EMPLOYEE_RETURNED, EMPLOYEE_TERMINATED,
        EMPLOYEE_REHIRED, EMPLOYEE_COMMISSION_CHANGED, EMPLOYEE_USER_LINKED,
        EMPLOYEE_USER_UNLINKED, EMPLOYEE_DELETE_DENIED, EMPLOYEE_DELETED,
        ROLE_CREATED, ROLE_UPDATED, ROLE_DELETED, ROLE_DELETE_DENIED,
